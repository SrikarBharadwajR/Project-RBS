...
#include <iostream>
using namespace std;
string whiteArray[9]  =  {"w","b","g","o","w","o","w","r","y"};
string yellowArray[9] =  {"y","r","r","w","y","y","o","g","w"};
string redArray[9]    =  {"r","y","b","o","r","b","o","b","y"};
string orangeArray[9] =  {"y","o","r","g","o","g","b","w","w"};
string blueArray[9]   =  {"r","w","o","w","b","r","g","b","o"};
string greenArray[9]  =  {"b","g","g","y","g","y","g","r","b"};
void SampleOutput()
{
    for (int i = 0; i <= 8; i++)
    {
...
void WhiteMotorClk()
{
    ...
    cout << "White Motor Turned ClockWise" << endl;
    // SampleOutput();
}
void WhiteMotorAClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "White Motor Turned Anti ClockWise" << endl;
    // SampleOutput();
}
void YellowMotorClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Yellow Motor Turned ClockWise" << endl;
    // SampleOutput();
}
void YellowMotorAClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Yellow Motor Turned Anti ClockWise" << endl;
    // SampleOutput();
}
void RedMotorClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Red Motor Turned ClockWise" << endl;
    // SampleOutput();
}
void RedMotorAClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Red Motor Turned Anti ClockWise" << endl;
    // SampleOutput();
}
void OrangeMotorClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Orange Motor Turned ClockWise" << endl;
    // SampleOutput();
}
void OrangeMotorAClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Orange Motor Turned Anti ClockWise" << endl;
    // SampleOutput();
}
void BlueMotorClk()
{
    ...
    newyellowArray[2] = orangeArray[6];
    newyellowArray[5] = orangeArray[3];
    newyellowArray[8] = orangeArray[0];
    ...
    for (int i = 0; i < 9; i++)
        if (newblueArray[i] != "")
            blueArray[i] = newblueArray[i];
    cout << "Blue Motor Turned ClockWise" << endl;
    // SampleOutput();
}
void BlueMotorAClk()
{
    ...
    neworangeArray[6] = yellowArray[2];
    neworangeArray[3] = yellowArray[5];
    neworangeArray[0] = yellowArray[8];
    ...
    newblueArray[0] = blueArray[2];
    newblueArray[1] = blueArray[5];
    newblueArray[2] = blueArray[8];
    newblueArray[3] = blueArray[1];
    newblueArray[5] = blueArray[7];
    newblueArray[6] = blueArray[0];
    newblueArray[7] = blueArray[3];
    newblueArray[8] = blueArray[6];
    for (int i = 0; i < 9; i++)
        if (newwhiteArray[i] != "")
            whiteArray[i] = newwhiteArray[i];
    for (int i = 0; i < 9; i++)
    ...
    for (int i = 0; i < 9; i++)
        if (newblueArray[i] != "")
            blueArray[i] = newblueArray[i];
    cout << "Blue Motor Turned Anti ClockWise" << endl;
    // SampleOutput();
}
void GreenMotorClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Green Motor Turned ClockWise" << endl;
    // SampleOutput();
}
void GreenMotorAClk()
{
    ...
    for (int i = 0; i < 9; i++)
        if (newgreenArray[i] != "")
            greenArray[i] = newgreenArray[i];
    cout << "Green Motor Turned Anti ClockWise" << endl;
    // SampleOutput();
}
/*int main()
{
