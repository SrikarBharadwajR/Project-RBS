...
color_no = np.array(
    ...
    [[15, 141, 111],[29, 255, 155]],   #yellow
    [[0, 173, 68],[5, 55, 255]],       #red
    [[6, 147, 120],[10, 255, 255]],    #orange
    [[97, 33, 31],[130, 255, 255]],    #blue
    [[0, 0, 0],[95, 182, 78]]]         #green
    )        
...
while True:
    ...
    cube1=[[coord1[0]-(cw+gap+mcw), coord1[1]], [coord1[0]-(gap+mcw), coord1[1]+(cw)]]
    cube2=[[coord1[0]-mcw, coord1[1]], [coord1[0]+mcw , coord1[1]+(cw)]]
    cube3=[[coord1[0]+(cw+gap+mcw), coord1[1]], [coord1[0]+(gap+mcw), coord1[1]+(cw)]]
    cube4=[[coord1[0]-(cw+gap+mcw), coord1[1]+cw+gap], [coord1[0]-(gap+mcw), coord1[1]+(2*cw+gap)]]
    cube5=[[coord1[0]-mcw, coord1[1]+(cw+gap)], [coord1[0]+mcw , coord1[1]+(2*cw+gap)]]
    cube6=[[coord1[0]+(cw+gap+mcw), coord1[1]+(cw+gap)], [coord1[0]+(gap+mcw), coord1[1]+(2*cw+gap)]]
    cube7=[[coord1[0]-(cw+gap+mcw), coord1[1]+(2*cw+2*gap)], [coord1[0]-(gap+mcw), coord1[1]+(3*cw+2*gap)]]
    cube8=[[coord1[0]-mcw, coord1[1]+(2*cw+2*gap)], [coord1[0]+mcw , coord1[1]+(3*cw+2*gap)]]
    cube9=[[coord1[0]+(cw+gap+mcw), coord1[1]+(2*cw+2*gap)], [coord1[0]+(gap+mcw), coord1[1]+(3*cw+2*gap)]]
    #creating cubes with rectangle()
    cv2.rectangle(frame, cube1[0], cube1[1] , colour, thickness)
    cv2.rectangle(frame, cube2[0], cube2[1], colour, thickness)
    cv2.rectangle(frame, cube3[0], cube3[1] , colour, thickness)
    cv2.rectangle(frame, cube4[0], cube4[1] , colour, thickness)
    cv2.rectangle(frame, cube5[0], cube5[1] , colour, thickness)
    cv2.rectangle(frame, cube6[0], cube6[1] , colour, thickness)
    cv2.rectangle(frame, cube7[0], cube7[1] , colour, thickness)
    cv2.rectangle(frame, cube8[0], cube8[1] , colour, thickness)
    cv2.rectangle(frame, cube9[0], cube9[1] , colour, thickness)
    #creating roi for detection of color
    roi1 = frame[cube1[0][1]:cube1[1][1],  cube1[0][0]:cube1[1][0]]
    roi2 = frame[cube2[0][1]:cube2[1][1],  cube2[0][0]:cube2[1][0]]
    roi3 = frame[cube3[0][1]:cube3[1][1],  cube3[0][0]:cube3[1][0]]
    roi4 = frame[cube4[0][1]:cube4[1][1],  cube4[0][0]:cube4[1][0]]
    roi5 = frame[cube5[0][1]:cube5[1][1],  cube5[0][0]:cube5[1][0]]
    roi6 = frame[cube6[0][1]:cube6[1][1],  cube6[0][0]:cube6[1][0]]
    roi7 = frame[cube7[0][1]:cube7[1][1],  cube7[0][0]:cube7[1][0]]
    roi8 = frame[cube8[0][1]:cube8[1][1],  cube8[0][0]:cube8[1][0]]
    roi9 = frame[cube9[0][1]:cube9[1][1],  cube9[0][0]:cube9[1][0]]
    ...
    cv2.imshow("frame1", roi1)
    cv2.imshow("frame2", roi2)
    #cv2.imshow("frame3", roi3)
    cv2.imshow("frame4", roi4)
    cv2.imshow("frame5", roi5)
    # cv2.imshow("frame6", roi6)
    cv2.imshow("frame7", roi7)
    cv2.imshow("frame8", roi8)
    # cv2.imshow("frame9", roi9)
